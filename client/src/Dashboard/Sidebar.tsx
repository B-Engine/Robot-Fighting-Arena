...
const SidebarTile = styled.button`
  font-weight: normal;
...
function blur(e: React.MouseEvent) {
  if (
...
const RawSidebar: FunctionComponent<RouteComponentProps> = props => {
  return (
    <SidebarContainer>
      <SidebarTile
        onClick={() => props.history.push('/arena')}
        onMouseLeave={blur}
      >
        ARENA
        <ArenaIcon size={'3em'} color={'yellow'} />
      </SidebarTile>
      <SidebarTile
        onClick={() => props.history.push('/garage')}
        onMouseLeave={blur}
      >
        GARAGE
        <GarageIcon size={'3em'} color={'gray'} />
      </SidebarTile>
      <SidebarTile
      ...
      >
        MARKET
        <MarketIcon size={'3em'} color={'green'} />
      </SidebarTile>
      <SidebarTile
      ...
      >
        NEWS
        <NewsIcon size={'3em'} color={'white'} />
      </SidebarTile>
    </SidebarContainer>
  );
};

export const Sidebar = withRouter(RawSidebar);
